...
?>
	<label>
		<input type="search" placeholder="<?php echo esc_html__( 'Busca rápida', 'shopkit' ); ?>" value="<?php echo get_search_query(); ?>" name="s" title="<?php echo esc_html__( 'Search for', 'shopkit' ); ?>" />
	</label>
<?php
